# LearnLoop — SQLite MCP Architecture Design

> **Design Goal:** Transform LearnLoop into a pure skill-level system where ALL data operations go through SQLite MCP, eliminating Python script dependencies.
...
Transform the LearnLoop from Python-script-backed to **pure skill-level architecture**:
...
## Documentation
- [Architecture Design](docs/learnloop/specs/2026-09-03-sqlite-mcp-skill-architecture-design.md)
