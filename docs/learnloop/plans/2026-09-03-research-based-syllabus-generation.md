...
- All prompts embedded in SKILL.md or separate prompt files in docs/learnloop/prompts/
...
**Files:**
- Create: `docs/learnloop/mcp-queries/migrations/001-topic-sources-links.sql`
- Modify: `docs/learnloop/mcp-queries/schema.sql` (add new tables at end)
...
Append to `docs/learnloop/mcp-queries/schema.sql` after line 99:
...
sqlite3 /tmp/test-mit-schema.db < docs/learnloop/mcp-queries/schema.sql
...
```bash
git add docs/learnloop/mcp-queries/schema.sql docs/learnloop/mcp-queries/migrations/
...
**Files:**
- Create: `docs/learnloop/prompts/discovery-agent-official.md`
- Create: `docs/learnloop/prompts/discovery-agent-academic.md`
- Create: `docs/learnloop/prompts/discovery-agent-practical.md`
- Create: `docs/learnloop/prompts/discovery-agent-expert.md`
...
```bash
git add docs/learnloop/prompts/discovery-agent-*.md
...
**Files:**
- Create: `docs/learnloop/prompts/critic-agent.md`
...
```bash
git add docs/learnloop/prompts/critic-agent.md
...
ls ~/.claude/skills/mit-learning/docs/learnloop/prompts/ | grep discovery
ls ~/.claude/skills/mit-learning/docs/learnloop/mcp-queries/ | grep schema
```
...
2. Remove new prompt files: `rm docs/learnloop/prompts/discovery-*.md docs/learnloop/prompts/critic-agent.md`
