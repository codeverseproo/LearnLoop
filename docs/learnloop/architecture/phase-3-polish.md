...
**Timeline:** Week 3
**Stories:** 3 (LL-010 through LL-012)
...
LL-010 (Error Handling) ───> LL-011 (Testing) ───> LL-012 (Python Deprecation)
        │                           │                        │
        └─ Try/catch in MCP        └─ Test coverage        └─ Remove scripts
```

**Execution order:** LL-010 → LL-011 → LL-012
...
**Files affected:**
- `docs/learnloop/mcp-queries/schema.sql` (CHECK constraints)
...
**Execution prompt:** [LL-010-execution.md](prompts/LL-010-execution.md)
...
**Files affected:**
- `docs/learnloop/tests/` (new directory)
...
**Execution prompt:** [LL-011-execution.md](prompts/LL-011-execution.md)
...
**Execution prompt:** [LL-012-execution.md](prompts/LL-012-execution.md)
...
# 2. All tests pass
for test in docs/learnloop/tests/**/*.sql; do
...
time sqlite3 ~/.mit-learning/goals/test/memory.db < docs/learnloop/mcp-queries/fsrs.sql
...
1. **Architecture:**
   - 12 MCP query files in `docs/learnloop/mcp-queries/`
